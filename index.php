...
?>
        ...
        <div class="col-lg-8">
          <div class="well bs-component">
            ...
            echo '<legend>Flights from '.$from.' to '.$to.'</legend>';
              ...
              <img src="vendor/img/flight.jpg" width="100%">
              <h3>Services offered by Air India</h3>
              ...
              <h5>Book hotels via Indian Airlines and avail 10% discount per room</h5>
              <h5>Discounted travel coupons for every city</h5>
              <h5>Hire cabs or bus via Indian Airlines and avail 10% discount per ticket</h5>
      ...
      <div id="boxes">
        <div style="top: 199.5px; left: 551.5px; color:black;" id="dialog" class="window">
         <?php 
          $rss = display_last_visit();
          if($rss){
         ?>
        * Recommended For You 
        <a href="#" class="close"><img src="vendor/img/close.png" width="40px;"></a>
        <table class="table">
                  <tbody>
                  <?php foreach ($rss as $rs){ ?>
                  <tr>
                   <td><img src="<?= RandImg('vendor/img/image/'); ?>" width="100px;"></td>
