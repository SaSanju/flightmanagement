			...
			if(isset($_POST['chose_to'])===true) {
				if(isset($_POST['chose_fro'])===true) {
					...
					if($class==='Economy' && $counta==='1' && $countc==='0') {
						...
						$arrivedate = $_SESSION['returndate'];
								...
								while($row10 = mysql_fetch_assoc($r10)) {
									...
									if($balance) {
										...
										if($r11) {
											...
											$e2 = str_replace('-', '', $a2);
											$pnr1 = $e1.$e2;
											mysql_query("INSERT INTO `passenger_details` (`p_name`, `p_age`, `p_sex`, `p_pnr`, `p_fno`, `p_from`, `p_to`, `p_dedate`, `p_ardate`, `p_detime`, `p_artime`, `p_class`, `p_status`, `p_passtype`, `p_fid`) VALUES ('$aname1', '$asex1', '$aage1', '$pnr1', '$to', '$from_city', '$to_city', '$departdate', '$departdate', '$depart_time', '$arr_time', '$class', '$status', 'A', '$uid')");
										...
										if($r12) {
											...
											$e6 = str_replace('-', '', $a6);
											$pnr6 = $e5.$e6+100;
											mysql_query("INSERT INTO `passenger_details` (`p_name`, `p_age`, `p_sex`, `p_pnr`, `p_fno`, `p_from`, `p_to`, `p_dedate`, `p_ardate`, `p_detime`, `p_artime`, `p_class`, `p_status`, `p_passtype`, `p_fid`) VALUES ('$aname1', '$asex1', '$aage1', '$pnr6', '$fro', '$to_city', '$from_city', '$arrivedate', '$arrivedate', '$depart_time', '$arr_time', '$class', '$status', 'A', '$uid')");
